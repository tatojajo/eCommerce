...
import { Box, Typography, Divider, Grid, TextField, Button, InputAdornment } from '@mui/material';
import { useNavigate } from 'react-router-dom';
import { editPersonalInfo } from '../../../Helpers/Services/user';
import { UserDetailsContiner, UserInfo, UserText } from './userDetailsStyle';
